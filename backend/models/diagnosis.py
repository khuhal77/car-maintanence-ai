...
def classify_car_part_cnn(image_base64: str) -> dict:
    ...
    try:
        ...
        confidence = min(0.6, 0.3 + brightness * 0.2 + saturation * 0.15)
        ...
        diagnosis['recommendation'] = (
            f"{diagnosis['recommendation']} (Note: this is a low-confidence estimate — "
            f"for a reliable diagnosis, upload a clear close-up of the part or confirm with a mechanic.)"
        )
